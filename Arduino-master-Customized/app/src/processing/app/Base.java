...
//      }
  ...
  public void rebuildExamplesMenu(JMenu menu) {
    ...
    try {
      menu.removeAll();
	//  showMessage("test",BaseNoGui.getbari3ExamplesFolder().toString());
	  boolean found = addSketches(menu, BaseNoGui.getbari3ExamplesFolder(), false);
	  if (found) menu.addSeparator();
      // Add examples from distribution "example" folder
       found = addSketches(menu, BaseNoGui.getExamplesFolder(), false);
      if (found) menu.addSeparator();
...
//  }
  ...
  */
  ...
  static public void showEnvironment() {
    showReference("Reference/Bari3CMD");
  }
