...
public class JEditTextArea extends JComponent
{
  ...
  */
  ...
  public JEditTextArea(TextAreaDefaults defaults)
  {
	...
	//painter.setAlignmentX(RIGHT_ALIGNMENT);
...
//  }
  ...
  public int _offsetToX(int line, int offset)
  {
	...
	int shift =getWidth()-getLineLength(line)*fm.charWidth('w');         // ++ bari3
    ...
    if(tokenMarker == null)
      ...
      // return x + Utilities.getTabbedTextWidth(lineSegment,
                                             //   fm,x,painter,0);
		 return shift + Utilities.getTabbedTextWidth(lineSegment,
                                               fm,0,painter,0) ;
      }
            ...
            if(offset + segmentOffset < lineSegment.offset + length)
              {
                ...
                return shift+ Utilities.getTabbedTextWidth(
                                                        lineSegment,fm,0,painter,0); //bari3++
              }
            else
              {
                lineSegment.count = length;
                x += Utilities.getTabbedTextWidth(
                                                  lineSegment,fm,0,painter,0);
        ...
        else
          {
            ...
            if(selectedText != null)
			 ...
			 // selectedText
                ...
                document.insertString((getLineLength(getCaretLine())-selectionStart)+1,
                                     selectedText,null);
  ...
  public void overwriteSetSelectedText(String str)
  {
    ...
    try
      {
        document.remove(caret,2);
        document.insertString(caret,"ok",null);
      }
    catch(BadLocationException bl)
      {
        bl.printStackTrace();
