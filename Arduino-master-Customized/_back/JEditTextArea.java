...
public class JEditTextArea extends JComponent
{
  ...
  */
  ...
  public JEditTextArea(TextAreaDefaults defaults)
  {
    ...
    painter.setComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
	 painter.applyComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
	 
	  painter.setAlignmentX(TextAreaPainter.RIGHT_ALIGNMENT);
	
	 // painter.setComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
	
	//editorLineNumbers.setComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
    //editorLineNumbers.applyComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
   // vertical.setComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
   //vertical.applyComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
   // horizontal.setComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
  //  horizontal.applyComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
   ...
   // painter.addMouseMotionListener(new DragHandler());
    ...
    //setAlignmentX(JTextArea.RIGHT_ALIGNMENT);
    // Load the defaults
	...
	//focusedComponent.setComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
	// focusedComponent.applyComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
	//focusedComponent.setAlignmentX(RIGHT_ALIGNMENT);
