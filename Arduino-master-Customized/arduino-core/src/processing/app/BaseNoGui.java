...
public class BaseNoGui {
  ...
  static private File examplesFolder;
   static private File bari3examplesFolder;
  ...
  static public File getbari3ExamplesFolder() {
    return bari3examplesFolder;
  }

  static public String getbari3ExamplesPath() {
    return bari3examplesFolder.getAbsolutePath();
  }
  ...
  static public void onBoardOrPortChange() {
         examplesFolder = getContentFile("examples");
		  bari3examplesFolder = getContentFile("bari3examples");
